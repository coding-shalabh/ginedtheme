...
import AddCategory from "./components/pages/addCategory"; //Adding Course Category
import AddCourse from "./components/pages/addCourse"; //Adding Course Course
import AddCollege from "./components/pages/addCollege"; //Adding Course College
